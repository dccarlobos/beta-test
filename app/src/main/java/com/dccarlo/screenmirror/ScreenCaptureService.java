...
public class ScreenCaptureService extends Service {
  ...
  private void sendIceCandidateToServer(
        org.webrtc.IceCandidate candidate) {
    ...
    new Thread(() -> {
        ...
        try {
            ...
            message.put("session", SESSION_ID);
            message.put("from", "phone");
            message.put("to", "tv");
            ...
            message.put("candidate", ice);

            URL url = new URL(SIGNAL_URL);
  ...
  private void handleSignalMessage(
        JSONObject message) {
    ...
    if (
        ...
        if (peerConnection == null) {
            ...
            Log.e(
                    TAG,
                    "Cannot set answer: PeerConnection is null"
            );
        ...
        peerConnection.setRemoteDescription(
                new SdpObserver() {
                    ...
                    public void onSetSuccess() {
                        ...
                        Log.d(
                                TAG,
                                "REMOTE SDP ANSWER SET SUCCESSFULLY"
                        );
